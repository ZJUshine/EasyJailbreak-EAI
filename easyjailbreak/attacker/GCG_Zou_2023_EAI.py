...
class GCGEAI(AttackerBase):
    ...
    def attack(self):
        ...
        try:
            ...
            # self.target_model.set_system_message = "You are a helpful assistant that pays attention to the user's instructions and writes good python code for operating a robot arm in a tabletop environment."
